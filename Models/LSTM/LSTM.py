...
class LSTM():
    ...
    def build_model(self):
        ...
        self.model.add(
            tf.keras.layers.LSTM(input_shape=[self.X_train.shape[1], self.X_train.shape[2]], units=self.LAYERS[0],
    ...
    def evaluate_model(self, dataset):
        ...
        plot_features_importance(dataset, self.model)
...
def main():
    ...
    LSTM_classifier_full.evaluate_model(dataset_full)
    ...
    LSTM_classifier_lag.evaluate_model(dataset_lag)
    ...
    LSTM_classifier_raw.evaluate_model(dataset_raw)
